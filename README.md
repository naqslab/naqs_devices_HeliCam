...
- [naqs\_devices\_HeliCam](#naqs_devices_helicam)
  - [Directory structure](#directory-structure)
  - [Example Labscript usage](#example-labscript-usage)
    - [Example Connection Tables](#example-connection-tables)
      - [Normal mode](#normal-mode)
      - [ExtTqp mode](#exttqp-mode)
    - [Example Experiment script](#example-experiment-script)
    - [Example analysis script](#example-analysis-script)
  - [The Device Driver](#the-device-driver)
  - [Device specs testing](#device-specs-testing)
