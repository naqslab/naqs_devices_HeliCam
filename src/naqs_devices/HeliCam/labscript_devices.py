...
from labscript import TriggerableDevice, set_passed_properties, LabscriptError
import numpy as np
...
class HeliCam(TriggerableDevice):
        ...
        **kwargs
        ...
        Args:
            ...
            trigger_duration (float or None), default: `None`:
                ...
                As per the HeliCam C3 docs, this must be greater than 10 us.
            ...
            camera_attributes (dict, optional):
                ...
                - ``CamMode``: Camera Mode, Currently supporting: (0=RAW_IQ, 3=HDR)
        ...
        if trigger_duration < 10e-6:
            raise LabscriptError('HeliCam trigger duration must be > 10 us')
    ...
    def frequency_to_tqp(self, freq):
        ...
        """
        tqp = 70e6 / (8 * freq) - 30
        assert tqp < 4096, f"Requested Frequency {freq} corresponding to {tqp} out of bounds  (too low)"
        return int(tqp)
